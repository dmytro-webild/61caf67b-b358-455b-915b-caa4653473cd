      ...
      features={[
        {
          ...
          description: "Expert AC installation and repair services.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/close-up-ventilation-system_23-2149388946.jpg",
          },
          phoneTwo: {
        ...
        },
        {
          ...
          description: "Furnace and heat pump expertise for cold days.",
          phoneOne: {
        ...
        },
        {
          ...
          description: "Purification and filtration solutions.",
          phoneOne: {
      ...
      plans={[
        {
          ...
          price: "$99",
          period: "/year",
          description: "Basic seasonal checkup.",
          button: {
            text: "Select",
          },
        ...
        },
        {
          ...
          price: "$199",
          period: "/year",
          description: "Full system protection.",
          button: {
            text: "Select",
          },
          featuresTitle: "Includes:",
      ...
      faqs={[
        {
          ...
          content: "We recommend servicing at least once a year, ideally in spring.",
        },
        {
          id: "q2",
          title: "Are your technicians certified?",
          content: "Yes, all of our technicians hold HVAC industry standard certifications.",
        },
        {
          id: "q3",
          title: "Do you offer emergency service?",
          content: "Yes, we are available 24/7 for urgent HVAC issues.",
        },
      ]}
